...
class __scm_export(gl_core) face : public scm::font::face
{
protected:
...
typedef boost::shared_ptr<scm::gl_classic::face>        face_ptr;
typedef boost::shared_ptr<const scm::gl_classic::face>  face_const_ptr;
