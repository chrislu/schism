...
#ifndef SCM_GL_CORE_TEXTURE_OBJECTS_H_INCLUDED
#define SCM_GL_CORE_TEXTURE_OBJECTS_H_INCLUDED
...
#include <scm/gl_core/texture_objects/texture_buffer.h>

#endif // SCM_GL_CORE_TEXTURE_OBJECTS_H_INCLUDED
