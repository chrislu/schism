...
#ifndef SCM_GL_CORE_TRACKBALL_MANIPULATOR_H_INCLUDED
#define SCM_GL_CORE_TRACKBALL_MANIPULATOR_H_INCLUDED
...
class __scm_export(gl_core) trackball_manipulator
{
public:
...
#endif // SCM_GL_CORE_TRACKBALL_MANIPULATOR_H_INCLUDED
