...
#ifndef SCM_GL_CORE_MANIP_ARCBALL_H_INCLUDED
#define SCM_GL_CORE_MANIP_ARCBALL_H_INCLUDED
...
class __scm_export(gl_core) arc_ball
{
public:
...
#endif // SCM_GL_CORE_MANIP_ARCBALL_H_INCLUDED
