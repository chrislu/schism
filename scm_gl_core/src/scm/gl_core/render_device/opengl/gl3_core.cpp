...
#define SCM_INIT_GL_ENTRY(PFN, fun, errflag)                                                \
    ...
    SCM_INIT_GL_ENTRY(PFNGLENABLEINDEXEDEXTPROC, glEnableIndexedEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLDISABLEINDEXEDEXTPROC, glDisableIndexedEXT, init_success);
    ...
    SCM_INIT_GL_ENTRY(PFNGLVERTEXARRAYVERTEXATTRIBOFFSETEXTPROC, glVertexArrayVertexAttribOffsetEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLVERTEXARRAYVERTEXATTRIBIOFFSETEXTPROC, glVertexArrayVertexAttribIOffsetEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLENABLEVERTEXARRAYATTRIBEXTPROC, glEnableVertexArrayAttribEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLDISABLEVERTEXARRAYATTRIBEXTPROC, glDisableVertexArrayAttribEXT, init_success);
    ...
    // texture handling ///////////////////////////////////////////////////////////////////////////
    SCM_INIT_GL_ENTRY(PFNGLTEXTUREPARAMETERFEXTPROC, glTextureParameterfEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLTEXTUREPARAMETERFVEXTPROC, glTextureParameterfvEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLTEXTUREPARAMETERIEXTPROC, glTextureParameteriEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLTEXTUREPARAMETERIVEXTPROC, glTextureParameterivEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLTEXTUREPARAMETERIIVEXTPROC, glTextureParameterIivEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLTEXTUREPARAMETERIUIVEXTPROC, glTextureParameterIuivEXT, init_success);

    SCM_INIT_GL_ENTRY(PFNGLTEXTUREIMAGE1DEXTPROC, glTextureImage1DEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLTEXTUREIMAGE2DEXTPROC, glTextureImage2DEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLTEXTUREIMAGE3DEXTPROC, glTextureImage3DEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLTEXTURESUBIMAGE1DEXTPROC, glTextureSubImage1DEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLTEXTURESUBIMAGE2DEXTPROC, glTextureSubImage2DEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLTEXTURESUBIMAGE3DEXTPROC, glTextureSubImage3DEXT, init_success);
    
    SCM_INIT_GL_ENTRY(PFNGLTEXTUREBUFFEREXTPROC, glTextureBufferEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLMULTITEXBUFFEREXTPROC, glMultiTexBufferEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLBINDMULTITEXTUREEXTPROC, glBindMultiTextureEXT, init_success);

    // frame buffer handling //////////////////////////////////////////////////////////////////////
    SCM_INIT_GL_ENTRY(PFNGLNAMEDRENDERBUFFERSTORAGEEXTPROC, glNamedRenderbufferStorageEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLGETNAMEDRENDERBUFFERPARAMETERIVEXTPROC, glGetNamedRenderbufferParameterivEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLCHECKNAMEDFRAMEBUFFERSTATUSEXTPROC, glCheckNamedFramebufferStatusEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLNAMEDFRAMEBUFFERTEXTURE1DEXTPROC, glNamedFramebufferTexture1DEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLNAMEDFRAMEBUFFERTEXTURE2DEXTPROC, glNamedFramebufferTexture2DEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLNAMEDFRAMEBUFFERTEXTURE3DEXTPROC, glNamedFramebufferTexture3DEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLNAMEDFRAMEBUFFERRENDERBUFFEREXTPROC, glNamedFramebufferRenderbufferEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLGETNAMEDFRAMEBUFFERATTACHMENTPARAMETERIVEXTPROC, glGetNamedFramebufferAttachmentParameterivEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLGENERATETEXTUREMIPMAPEXTPROC, glGenerateTextureMipmapEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLFRAMEBUFFERDRAWBUFFEREXTPROC, glFramebufferDrawBufferEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLFRAMEBUFFERDRAWBUFFERSEXTPROC, glFramebufferDrawBuffersEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLFRAMEBUFFERREADBUFFEREXTPROC, glFramebufferReadBufferEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLGETFRAMEBUFFERPARAMETERIVEXTPROC, glGetFramebufferParameterivEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLNAMEDRENDERBUFFERSTORAGEMULTISAMPLEEXTPROC, glNamedRenderbufferStorageMultisampleEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLNAMEDFRAMEBUFFERTEXTUREEXTPROC, glNamedFramebufferTextureEXT, init_success);
    SCM_INIT_GL_ENTRY(PFNGLNAMEDFRAMEBUFFERTEXTURELAYEREXTPROC, glNamedFramebufferTextureLayerEXT, init_success);
