...
gl_base_format(const data_format d)
{
    static unsigned gl_int_bfmts[] = {
        ...
        GL_RED,         // FORMAT_R_8I,
        GL_RG,          // FORMAT_RG_8I,
        GL_RGB,         // FORMAT_RGB_8I,
        GL_RGBA,        // FORMAT_RGBA_8I,

        GL_RED,         // FORMAT_R_16I,
        GL_RG,          // FORMAT_RG_16I,
        GL_RGB,         // FORMAT_RGB_16I,
        GL_RGBA,        // FORMAT_RGBA_16I,

        GL_RED,         // FORMAT_R_32I,
        GL_RG,          // FORMAT_RG_32I,
        GL_RGB,         // FORMAT_RGB_32I,
        GL_RGBA,        // FORMAT_RGBA_32I,

        GL_RED,         // FORMAT_R_8UI,
        GL_RG,          // FORMAT_RG_8UI,
        GL_RGB,         // FORMAT_RGB_8UI,
        GL_RGBA,        // FORMAT_RGBA_8UI,

        GL_RED,         // FORMAT_R_16UI,
        GL_RG,          // FORMAT_RG_16UI,
        GL_RGB,         // FORMAT_RGB_16UI,
        GL_RGBA,        // FORMAT_RGBA_16UI,

        GL_RED,         // FORMAT_R_32UI,
        GL_RG,          // FORMAT_RG_32UI,
        GL_RGB,         // FORMAT_RGB_32UI,
        GL_RGBA,        // FORMAT_RGBA_32UI,
