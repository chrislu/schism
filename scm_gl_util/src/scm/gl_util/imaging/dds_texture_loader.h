...
#ifndef SCM_GL_UTIL_DDS_TEXTURE_LOADER_H_INCLUDED
#define SCM_GL_UTIL_DDS_TEXTURE_LOADER_H_INCLUDED
...
//class __scm_export(gl_util) dds_texture_loader
//{
//
//public:
//
...
#endif // SCM_GL_UTIL_DDS_TEXTURE_LOADER_H_INCLUDED
