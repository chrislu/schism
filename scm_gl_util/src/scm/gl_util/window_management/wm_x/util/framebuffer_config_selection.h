...
#ifndef SCM_GL_UTIL_WM_X_FRAMEBUFFER_CONFIG_SELECTION_X_H_INCLUDED
#define SCM_GL_UTIL_WM_X_FRAMEBUFFER_CONFIG_SELECTION_X_H_INCLUDED
...
#endif // SCM_GL_UTIL_WM_X_FRAMEBUFFER_CONFIG_SELECTION_X_H_INCLUDED
