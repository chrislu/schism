...
#ifndef SCM_GL_UTIL_CONTEXT_FORMAT_H_INCLUDED
#define SCM_GL_UTIL_CONTEXT_FORMAT_H_INCLUDED
...
class __scm_export(gl_util) context_format
{
public:
    context_format();
    ...
    bool                    quad_buffer_stereo() const         { return (_quad_buffer_stereo); }
    ...
    void                    quad_buffer_stereo(bool v)         { _quad_buffer_stereo = v; }
...
#endif // SCM_GL_UTIL_CONTEXT_FORMAT_H_INCLUDED
