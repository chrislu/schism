...
#ifndef SCM_GL_UTIL_CONTEXT_BASE_H_INCLUDED
#define SCM_GL_UTIL_CONTEXT_BASE_H_INCLUDED
...
class __scm_export(gl_util) context_base : boost::noncopyable
{
public:
...
#endif // SCM_GL_UTIL_CONTEXT_BASE_H_INCLUDED
