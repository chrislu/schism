...
#ifndef VOLUME_FILTER_KERNEL_SOBEL3X3_H_INCLUDED
#define VOLUME_FILTER_KERNEL_SOBEL3X3_H_INCLUDED

#include "volume_filter_kernel.h"
...
#endif // VOLUME_FILTER_KERNEL_SOBEL3X3_H_INCLUDED