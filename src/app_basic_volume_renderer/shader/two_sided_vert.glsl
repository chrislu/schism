...
void main()
{
    ...
    //unc_color = mix(green, red, 1.0 - texture3D(_unc_texture, (_vert2unit * gl_Vertex).xyz).r);
    unc_color = mix(green, red, 1.0 - clamp(pow(texture3D(_unc_texture, (_vert2unit * gl_Vertex).xyz).r, 2.0), 0.0, 1.0));
