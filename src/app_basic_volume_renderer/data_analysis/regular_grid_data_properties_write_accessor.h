...
#ifndef REGULAR_GRID_DATA_PROPERTIES_WRITE_ACCESSOR_H_INCLUDED
#define REGULAR_GRID_DATA_PROPERTIES_WRITE_ACCESSOR_H_INCLUDED
...
namespace scm
{
    ...
    protected:
        virtual void set_value_range(regular_grid_data_properties<val_type>& target_prop, const scm::value_range<val_type>& vr);
...
#endif // REGULAR_GRID_DATA_PROPERTIES_WRITE_ACCESSOR_H_INCLUDED
