...
protected:
    ...
    cl::opencl_device_ptr           _cl_device;
    cl::command_queue_ptr           _cl_queue;

    volume_data_ptr                 _volume_data;
    volume_renderer_ptr             _volume_renderer;
    opencl_volume_data_ptr          _volume_data_opencl;
    opencl_volume_renderer_ptr      _volume_renderer_opencl;
