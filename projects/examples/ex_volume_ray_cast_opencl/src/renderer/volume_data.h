...
public:
    ...
    const gl::texture_2d_ptr&           color_alpha_map() const;
...
protected:
    ...
    gl::texture_2d_ptr                  create_color_alpha_map(const gl::render_device_ptr& in_device,
...
protected:
    ...
    gl::texture_2d_ptr                  _color_alpha_map;
