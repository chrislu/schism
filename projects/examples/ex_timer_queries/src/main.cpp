...
static const std::string    scm_application_name = "schism example: timer queries";
...
int main(int argc, char **argv)
{
   ...
   // data::application_window* app_window(new data::application_window(math::vec2ui(width, height), viewer_attribs, context_attribs, window_format));
    gl::gui::application_window* app_window(new gl::gui::application_window(viewport_size, viewer_attribs, context_attribs, window_format));
