...
class __scm_export(ogl) vertex_element
{
public:
    typedef enum {
        position,
...
class __scm_export(ogl) vertex_layout
{
public:
...
void __scm_export(ogl) swap(scm::gl::vertex_element& /*lhs*/,
                            scm::gl::vertex_element& /*rhs*/);

void __scm_export(ogl) swap(scm::gl::vertex_layout& /*lhs*/,
                            scm::gl::vertex_layout& /*rhs*/);
